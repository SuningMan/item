...
(function($) {    
    ...
    function isMatch(searchText, targetText) {  
    	var text = targetText.split(",");
    	return $.trim(text[1])!="" && text[1]==searchText; 
...
//                    if (node.text.indexOf(q) >= 0){  
    				var c = node.text.indexOf(q);
                    if (node.id.indexOf(q) >= 0 || node.text.indexOf(q) >= 0){  
                        $(node.target).show();  
                    } else {  
                        $(node.target).hide();  
                    }  
