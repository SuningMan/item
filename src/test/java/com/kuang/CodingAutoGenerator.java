...
public class CodingAutoGenerator {
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/wistron?serverTimezone=GMT%2B8&characterEncoding=utf-8&useSSL=false");
        ...
        strategy.setInclude("user","product","product_maintain","supplier","register_code");
