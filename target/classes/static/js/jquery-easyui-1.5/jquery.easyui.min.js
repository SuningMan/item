    ...
    statistics: function(jq) {
        ...
        if (footer['sum'] != "") {
            ...
            if (obj[opt[0][0].field] == undefined) {
                footer['sum'] += '"' + opt[0][0].field + '":"<b style=\'color:red;\'>合计:</b>"';//第0列显示为合计
                obj = eval('({' + footer['sum'] + '})');
            } else {
